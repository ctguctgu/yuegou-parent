...
public class LetterUtil {
	...
	private final static String POLYPHONE_TXT = "重庆|cq,音乐|yy";
	...
	public static String getAllFirstLetter(String str) {
		...
		// 多音字判定
		for (String polyphone : POLYPHONE_TXT.split(",")) {
	...
	public static void main(String[] args) {
		System.out.println(LetterUtil.getFirstLetter("源码时代").toUpperCase());
		String address = "东原D8";
